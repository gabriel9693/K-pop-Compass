...
function showResults() {
    ...
    if( scoreY / 8 > 0 && scoreX / 8 > 0 ) {
        ...
        resultDesc.innerHTML = "You are an <strong>Obsessed Centrist</strong> <br> An <strong>obsessed</strong> K-pop fan is a fan who is actively engaging with K-pop activities as well as their favorite idols’ life activities. These people might even support their idols financially. <br> <br> As a <strong>centrist</strong> of the Realism-Idealism axis, you recognize both negative and positive sides of K-pop equally.";
    } else if(scoreY / 8 < 0 && scoreX / 8 === 0) {
